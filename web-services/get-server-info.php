...
$servicename = "Get Server Info";
$action = "getserverinfo";
$req = array(); 
$req[] = array("Server ID", "serverid", "required", "");
...
<body>
<div id="wrapper">
<h2><a href="../ServiceCatalog.php"><?php echo $sitename; ?></a> - <?php echo $servicename; ?></h2>
